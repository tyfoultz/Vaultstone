...
| Phase 5 — Campaign Linking | ✅ Done | Party card "Link/Change" trigger opens `CharacterPickerModal`; `pick-character.tsx` checks `campaign_members.character_id` for cross-campaign assignment; Characters drawer shows per-card campaign badge. |
