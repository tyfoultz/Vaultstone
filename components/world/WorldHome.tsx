...
import { WorldOpeningBlock } from './WorldOpeningBlock';
import {
  WorldSectionAddCard,
  WorldSectionCard,
...
/**
 * Reusable world overview component. Lifted out of the standalone
 * `app/world/[worldId]/index.tsx` route so the same surface can be
...
export type WorldHomeProps = {
   ...
   *  even though this component doesn't currently surface a close
   *  affordance. The host can wire it through to the split close
