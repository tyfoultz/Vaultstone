...
export const worldMapIndexHref = (worldId: string): Href =>
  (`/world/${worldId}/map`) as unknown as Href;
...
export const worldPagesHref = (worldId: string): Href =>
  (`/world/${worldId}/pages`) as unknown as Href;
