...
-- ─────────────────────────────────────────────────────────────────────────
-- Extend edit-lock RPCs to allow users with 'edit' grants (not just owners).
-- ─────────────────────────────────────────────────────────────────────────
...
begin
  ...
  if not is_world_owner(v_world) and not user_can_edit_page(v_user, p_page_id) then
...
begin
  ...
  if not is_world_owner(v_world) and not user_can_edit_page(v_user, p_page_id) then return; end if;
